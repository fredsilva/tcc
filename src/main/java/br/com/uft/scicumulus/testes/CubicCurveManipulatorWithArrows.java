 ...
 * curve. Extended with arrows with the help of José Pereda:
 * http://stackoverflow.com/questions/26702519/javafx-line-curve-with-arrow-head
 * Original code by jewelsea:
 * http://stackoverflow.com/questions/13056795/cubiccurve-javafx
 */
public class CubicCurveManipulatorWithArrows extends Application {
  ...
  @Override public void start(final Stage stage) throws Exception {
    ...
    CubicCurve curve = createStartingCurve(act, act2);
...
//    root.getChildren().addAll(act, act2, controlLine1, controlLine2, curve, start, control1, control2, end);
    root.getChildren().addAll(act, act2, curve);
